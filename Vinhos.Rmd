...
##floresta
rf_model <- randomForest(quality ~. - qualidade,data = dados,  importance=TRUE ,ntree = 500)
...
table(predicao=predito, observado=dados$qualidade)
mean(predito == dados$qualidade)
varImpPlot(rf_model,main = "Importância das Variáveis",type = 2)
